# -*- coding: utf-8 -*-
"""Copia de Proyecto - Programación 2.ipynby
**Natalia Prieto estuvo aquí <3 ⋆୨୧⋆ presente presidente
**María Alejandra Peláez 𖦹°‧★⋆
...
for mes in meses:
  df_car_mes = pd.read_stata(f"/content/drive/MyDrive/Colab Notebooks/Programación II/Proyecto /Datos/{mes}/Características Generales.DTA")
  df_ocp_mes = pd.read_stata(f"/content/drive/MyDrive/Colab Notebooks/Programación II/Proyecto /Datos/{mes}/Ocupados.DTA")
...
df = df.rename(columns={"P3271" : "sexo",
                ...
                "P3042S1" : "años estudio",
                "P6426" : "tiempo en la empresa",
                "P6500" : "ing bruto",
                "P6800" : "hr trabajo sem",
                "P6790" : "# meses trabajados (ult. año)",
                "P6920" : "cotiza a pension",
                "P6640S1" : "hr extra rem (ult. sem)"})

var_rel = ["sexo","edad","parentesco jefe h","seg social salud", "nivel educativo","años estudio",
  "tiempo en la empresa","ing bruto","hr trabajo sem","# meses trabajados (ult. año)",
...
#Prueba de eliminación de valores Nan
conteo_nan = df['ing bruto'].isnull().sum()
print(f"Número de NaN en la columna: {conteo_nan}")

"""* **Regresiones**"""

# Efecto del género sobre horas de trabajo semanal

# Controles: "edad", "años estudio", "cotiza a pension"
...
plt.title('Ingreso Laboral Promedio por Género (1er Semestre)')
plt.xlabel('Mes')
...
nota = '* Se calculó de la siguiente manera: ((Ingreso laboral promedio de los hombres) - (Ingreso laboral promedio de las mujeres)/(Ingreso laboral promedio de los hombres)).'
...
1. Utilizando los primeros 8 meses del año
"""
...
df_predict_PARCIAL = df_predict_PARCIAL.rename(columns = {0 : 'Predicción', 'dif_ing' : 'Diferencia porcentual de ingresos'})
df_predict_PARCIAL

plt.figure(figsize=(10, 6))
df_predict_PARCIAL[['Diferencia porcentual de ingresos', 'Predicción']].plot(ax=plt.gca(), marker='o')
...
df_predict = df_predict.rename(columns = {0 : 'Predicción año 2025', 'dif_ing' : 'Diferencia porcentual de ingresos 2024'})

df_predict

plt.figure(figsize=(10, 6))
df_predict[['Diferencia porcentual de ingresos 2024', 'Predicción año 2025']].plot(ax=plt.gca(), marker='o')
plt.title('Diferencia promedio de ingresos hombre vs mujeres con predicciones')
plt.xlabel('Mes')
plt.ylabel('Diferencia porcentual')
plt.axhline(0, linestyle = '--',color ='black')
